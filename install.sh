...
python3 -m pip install streamlit requests python-docx genanki fpdf2 google-generativeai -q --disable-pip-version-check 2>/dev/null || \
python3 -m pip install streamlit requests python-docx genanki fpdf2 google-generativeai -q --user --disable-pip-version-check
